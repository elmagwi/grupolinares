...
<html>
    ...
    <body>
        <%
                consulta = "SELECT f.idFactura,c.razonSocial,f.serieFactura,f.login, f.numFactura,f.fechaFactura, CONCAT(f.moneda,' ',f.subtotal) AS subtotal,CONCAT(f.moneda,' ',f.igv) AS igv, CONCAT(f.moneda,' ',f.total) AS total,f.estado FROM cliente c INNER JOIN factura f ON c.idCliente=f.idCliente ORDER BY idFactura;";
    ...
    <td>
		...
		<a target="../" href="reportes/reporte_factura.jsp?repfac=<%=rs.getString("idFactura")%>" title="Imprimir" onclick="return confirm('Imprimir')"><img alt="" src="../imagenes/icons/print.gif"/></a>
    </td>
